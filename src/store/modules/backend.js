...
export default {
  ...
  actions: {
    ...
    */
    ...
    getProfileImageUrl: (address) => `${process.env.VUE_APP_BACKEND_URL}/profile/image/${address}`,
    ...
    getTipPreviewUrl: (previewLink) => `${process.env.VUE_APP_BACKEND_URL}${previewLink}`,
