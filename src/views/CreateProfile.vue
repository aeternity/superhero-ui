    ...
    <div class="container wrapper">
      <div class="row content">
        <div class="col-sm-12">
          ...
          <p>
            You can find your wallet address on your dashboard, right above your balance. It’s a random string of numbers and letters that starts with ak_.
          </p>
          ...
          <p>
            Once you’re in your dashboard, it is highly recommended that you back up your seed phrase. The seed phrase is somewhat like a password. You will need this seed phrase to retrieve your wallet in case you lose access to the extension for any reason (migrating to a new device, reinstalling browser, etc.).
          </p>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Write down the 12 words displayed on a piece of paper and keep this in a safe place that only you can find.
              </li>
            </ul>
          ...
          <p>
            In some cases, there may be slight delays in collecting tips. Give it a few minutes and try opening your wallet again. If the problem persists, you may ask questions through superherowallet@protonmail.com
          </p>
          ...
          <p>
            Hopefully, in the future, you will be able to cash out directly from AE into your bank. Or even better, you may not even need to cash out at all in a world where all merchants around you accept AE tokens. ;)
          </p>
