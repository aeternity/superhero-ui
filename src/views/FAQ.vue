    ...
    <div class="container wrapper mt-2">
      <div class="content faq-page">
        ...
        <p>
          ...
          <br>receive more information about using Superhero platform and wallet.
        </p>
        ...
        <expandable-block :title="'Who is Superhero?'">
          ...
          <br>Anyone, anywhere may use the platform.
          <br>Other websites may use the platform.
          <br>All have uncensored, equal ability to be Superhero.
          <br>As P2P – the only ones who are not part of Superhero intermediaries.
          <br>No 3
          <sup>rd</sup> party custodians will control
          content, or your ability to tip or receive tips.
          <br>Superhero is you and you and you and you… Without any “them” in-between.
        </expandable-block>
        <expandable-block :title="'How does Superhero work?'">
          Superhero is built on aeternity blockchain.
          <br>Because it is built on blockchain, actions are transparent.
          <br>Because it is built on the blockchain, actions are published forever.
          <br>Blockchain has promised a more free and decentralized future for society.
          <br>Superhero used blockchain as its foundation to make that promise a reality.
          <br>Superhero is an online community making a tangible difference in the real world.
        </expandable-block>
        <expandable-block :title="'How does tipping on Superhero work?'">
          ...
          <br>You can get tips at your URL.
          <br>And you can send a tip to any URL you want.
          <br>ANY URL.
          <br>Yes, any URL you want - regardless of whether the
          URL owner has installed the wallet or not.
          <br>
          <br>All you need to give, collect, or claim tips in ae is a Superhero Wallet of your own.
        </expandable-block>
        ...
        <expandable-block :title="'What does it cost? (How’s it free!?!)'">
          ...
          <br>Superhero does not take any commissions from tips.
          <br>Superhero is a non-profit, social impact project.
        </expandable-block>
        <expandable-block :title="'Where can I get tips with Superhero?'">
          Use Superhero alone to give / accept a tip of ae.
          <br>Used Superhero alongside other existing fiat-based
          tools to additionally give / accept a tip in ae.
          <br>
          <br>On Superhero’s platform, join a community posting,
          commenting, and tipping each other directly.
          <br>Off Superhero’s platform, add a Superhero button or
          link to your site so anyone can tip you directly.
          <br>On Superhero’s site and in the world wide web beyond Superhero’s site
          – build your support or give support without having any 3rd parties
          control your content or tips.
          <br>So long as a URL is live, it can be tipped.
        ...
        <expandable-block :title="'What about other wallets?'">
          ...
          In this case, the AE address cannot be used for Superhero.
          <br>
          <br>You can simply Generate a New Wallet on Superhero and top it up
        ...
        >
          ...
          <br>
          <br>You can simply Generate a New Wallet on Superhero and top it up by
        ...
        <expandable-block
          :title="'Do I have to add my wallet address to every Tweet?'"
        >
          No, as long as your twitter profile contains your .chain name linked
          to your Superhero wallet or Superhero wallet ae address visible in the bio,
          tips sent to your awesome tweets URL`s can be delivered to your wallet.
        </expandable-block>
        <expandable-block
